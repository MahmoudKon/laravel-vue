<template>
    ...
    <section class="todoapp">
        ...
        <section class="main">
            ...
            <ul class="todo-list">
                <li class="todo" v-for="todo in todos" :class="{ completed: todo.is_done }">
                    <div class="view">
                        <input class="toggle" type="checkbox" :checked="todo.is_done" @change="changeTodoStatus(todo.id)">
                        ...
                        <input autofocus type="text" style="z-index: 1; height: 45px; width: 100%; position: absolute; top: 0;" v-model="editTodo" v-if="showTodoInput == todo.id " @keyup.enter="updateTodo(todo.id, editTodo)">
